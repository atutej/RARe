...
class RepLLaMAWrapper:
    def __init__(self, with_instruct=False, *args, **kwargs):
        try:
        ...
        self.with_instruct = with_instruct
...
llama3p1_rare_hf = ModelMeta(
    loader=_loader(
        RepLLaMAWrapper,
        base_model_name_or_path="meta-llama/Meta-Llama-3.1-8B-Instruct",
        peft_model_name_or_path="atutej/RARe-Llama-3.1-8B-Instruct-LLM",
        device_map="auto",
        torch_dtype=torch.bfloat16,
    ),
    name="RARe-Llama-3.1-8B-Instruct-LLM-hf",
    languages=["eng_Latn"],
    open_source=True,
    revision="01c7f73d771dfac7d292323805ebc428287df4f9-ad5c1d0938a1e02954bcafb4d811ba2f34052e71",  # base-peft revision
    release_date="2024-09-15",
...
llama3_rare_hf = ModelMeta(
    loader=_loader(
        RepLLaMAWrapper,
        base_model_name_or_path="meta-llama/Meta-Llama-3-8B",
        peft_model_name_or_path="atutej/RARe-Llama-3-8B-LLM",
        device_map="auto",
        torch_dtype=torch.bfloat16,
    ),
    name="RARe-Llama-3-LLM-hf",
    languages=["eng_Latn"],
    open_source=True,
    revision="01c7f73d771dfac7d292323805ebc428287df4f9-ad5c1d0938a1e02954bcafb4d811ba2f34052e71",  # base-peft revision
    release_date="2024-09-15",
