...
e5_mistral_icret = ModelMeta(
    loader=partial(
        e5_loader,
        model_name_or_path="../../saved_models/E5-Instruct-RARe/5_train_m-e5-mistral-7b-instruct_p-last_token_b-512_l-1024_bidirectional-False_e-1_s-42_w-0_lr-0.0002_lora_r-16",
        attn="cccc",
        pooling_method="lasttoken",
        mode="embedding",
        torch_dtype=torch.float16,
